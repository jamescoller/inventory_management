...
class InventoryItemTable(tables.Table):
    name = tables.Column(
        accessor="product.name", verbose_name="Product", order_by="product__name"
    )
    sku = tables.Column(
        accessor="product.sku", verbose_name="SKU", order_by="product__sku"
    )
    upc = tables.Column(
        accessor="product.upc", verbose_name="UPC", order_by="product__upc"
    )
